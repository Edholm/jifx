...
public class StateServiceTest {
    ...
    public void valueOf() throws Exception {
        StateService ss = new StateService.Builder(Service.UDP, Port.of(1337)).source(0xedaade).build();
    ...
    public void getContent() throws Exception {
        StateService ss = new StateService.Builder(Service.UDP, Port.of(0x100)).build();
    ...
    public void serviceUnavailable() throws Exception {
        StateService ss1 = new StateService.Builder(Service.UDP, Port.of(0)).build();
        StateService ss2 = new StateService.Builder(Service.UDP, Port.of(1024)).build();
